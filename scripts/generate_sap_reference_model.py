...
def main() -> None:
    ...
    mapping_to_vmap: dict[str, str] = {
        "MAP-LEGACY-CUST-GROUP-TO-FEP-S4-KNVV-KDGRP": ("VMAP-CUSTOMER-GROUP-LEGACY-TO-S4"),
        "MAP-LEGACY-VEND-ACCOUNT-GROUP-TO-FEP-S4-LFA1-KTOKK": (
            "VMAP-VENDOR-ACCOUNT-GROUP-LEGACY-TO-S4"
        ),
        "MAP-LEGACY-CUST-INDUSTRY-TO-FEP-S4-KNA1-BRSCH": ("VMAP-INDUSTRY-CODE-LEGACY-TO-S4"),
        "MAP-LEGACY-VEND-INDUSTRY-TO-FEP-S4-LFA1-BRSCH": ("VMAP-INDUSTRY-CODE-LEGACY-TO-S4"),
        "MAP-LEGACY-CUST-PAYMENT-TERMS-TO-FEP-S4-KNB1-ZTERM": ("VMAP-PAYMENT-TERMS-LEGACY-TO-S4"),
        "MAP-LEGACY-VEND-PAYMENT-TERMS-TO-FEP-S4-LFB1-ZTERM": ("VMAP-PAYMENT-TERMS-LEGACY-TO-S4"),
        "MAP-LEGACY-CUST-INCOTERMS-TO-FEP-S4-KNVV-INCO1": ("VMAP-INCOTERMS-LEGACY-TO-S4"),
